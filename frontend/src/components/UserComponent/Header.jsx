...
export default function Header() {
  ...
  const unReadMessage = getNotifications[0]?.notification?.filter(
  ...
  const userNavigation = [{ name: "Sign out", function: logoutHandler }];
          ...
          <div className="flex lg:hidden">
            <div className="relative">
              <BellIcon
                ...
                className="w-5 h-6 text-white mr-3"
              />
          ...
          <Popover.Group className="hidden lg:flex lg:gap-x-12">
            {pages.map((pages, index) => (
              <Link
                ...
                className={
                  current === pages
                    ? "text-sm font-semibold leading-6 text-white bg-indigo-600 rounded px-1"
                      ...
                      <ul>
                        {unReadMessage?.map((notification, index) => (
                          <li
                            ...
                            className=" text-center text-xs my-2 bg-sky-500 rounded p-2"
                          >
                              ...
                              {() => (
                                <>
                                  <Link
                                    className={
                                      current === "PROFILE"
                                        ? "block px-4 py-2 text-sm text-white w-full text-center bg-indigo-600"
            ...
            <div className="flex items-center justify-between">
              <Link className="-m-1.5 p-1.5">
                ...
                <img
                  ...
                  src="https://www.spots.in//wp-content/uploads/2018/10/WHITE.png"
                  alt=""
                />
              </Link>
              <button
                ...
                <div className="space-y-2 py-6">
                  {pages.map((page, index) => (
                    <Link
                      ...
                      className={
                        current === page
                          ? "-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-black bg-indigo-600/90 hover:bg-indigo-600"
                          : "-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white hover:bg-indigo-600"
                      }
                    >
                      {page}
                    </Link>
                  ...
                  {userInfo ? (
                    <>
                      <Link
                        className={
                          current === "PROFILE"
                            ? "-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-indigo-600 hover:bg-gray-50 bg-white"
                            : "-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-indigo-600 hover:bg-gray-50"
                        }
                        to={"/profile"}
                      >
                        Profile
                    ...
                    <div>
                      <Link
                        to="/login"
                        className="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-indigo-600 hover:bg-gray-100"
                      >
                        Log in
                      </Link>
                      <Link
